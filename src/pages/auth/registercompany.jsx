                ...
                <div className='ms-4 mt-5'>
                    ...
                    <form action="" className='mt-4'>
                        ...
                        <div className='mt-3'>
                            ...
                            <input type="text" placeholder='Posisi di perusahaan anda' className='form-control'/>
                        </div>
                        <div className='mb-3 mt-3'>
                            <label htmlFor="">Email</label>
                        ...
                        <p className="text-center mt-4">Anda sudah punya akun? <Link to={'/logincompany'} style={{color: '#FBB017', textDecoration:'none'}}>Masuk disini</Link></p>
                    </form>
                </div>
            </div>
        </div>
